...
public enum FrequenceDeplacement {
     ...
     * Constructeur
     * 
     * @param m       Le message qui sera affiché à l'usager pour sélectionner cette
     *                fréquence
    ...
    /**
     * Retourne le message qui sera présenté à l'usager pour sélectionner cette
     * fréquence
     * 
     * @return Le message qui sera présenté à l'usager pour sélectionner cette
     *         fréquence
     */
