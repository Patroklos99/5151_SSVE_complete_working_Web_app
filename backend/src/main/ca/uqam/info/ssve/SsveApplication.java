...
public class SsveApplication {
	...
	CommandLineRunner commandLineRunner(VehicleRepository repository) {
		return args -> {
			...
			repository.save(new Vehicle("Audi", "e-tron", 4, "SUV", 87342, 364000,95, 5, "https://www.audi" +
					".ca/ca/web/en/models/etron/e-tron-quattro.html", "src/main/resources/images/audiETron.png"));
			repository.save(new Vehicle("BMW", "i4", 4, "Sedan", 54990, 484000, 84, 4, "https://www.bmw" +
			...
			repository.save(new Vehicle("Ford Mustang", "Mach-E", 4, "SUV", 51495, 418000, 70, -1, "https://www.ford" +
